                            ...
                            <div class="panel-wrapper">
                                <div class="panel-body" style="padding: 40px">
                                    <div class="form-group text-center mb-40">
                                        <h6 style="font-size: 2em" class="txt-dark">Need to unlock your account?</h6>
                                    </div>
                                    <div class="form-group">
                                        <div id="alert-message"></div>
                                    </div>   
                                    <div class="form-group">
                                        <input type="email" class="form-control" name="tb-email" required="" id="tb-email" placeholder="Email Address">
                                    </div>
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-sm pull-right" id="btn-submit">Send</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function(){
            $("#btn-submit").on("click", function(){
                ...
                $.ajax({
                    url: "_functions.php",
                    type: "post",
                    data: { action: "send-unlock", email: $("#tb-email").val() },
