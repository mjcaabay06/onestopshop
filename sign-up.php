                            ...
                            <div class="panel-wrapper">
                                <div class="panel-body" style="padding: 40px">
                                    <form method="post" action="_functions.php" id="form-sign-up">
                                        ...
                                        <div id="pan-complete" class="col-sm-12">
                                           <!--  <div class="form-group text-center mb-40">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control txt-dark" required="" name="tb-answer" id="tb-answer" placeholder="Your answer">
                                            </div>

                                            <div class="form-group text-center mt-50 mb-10">
                                                <h6 style="font-size: 1.5em" class="txt-dark">Account Details</h6>
                                            </div>
                                            <div class="form-group">
   ...
   <!-- Javascript -->
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("input[name=tb-email]").on("keyup",function(){
            ...
            $("#tb-password").on("keyup",function(){
                checkPassword();
            });
            $("#tb-confirm-password").on("keyup",function(){
                confirmPassword();
            });
